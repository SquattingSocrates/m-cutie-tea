...
impl ByteParser {
    ...
    pub fn parse_variable_header_publish(&mut self, qos: u8) -> Result<PublishVariableHeader, String> {
    ...
    pub fn parse_variable_header_subscribe(&mut self, qos: u8) -> Result<MessageIDVariableHeader, String> {
        Ok(
    ...
    pub fn parse_connect_message(&mut self, fixed_header: FixedHeader) -> Result<MqttMessage, String> {
    ...
    pub fn parse_publish_message(&mut self, fixed_header: FixedHeader) -> Result<MqttMessage, String> {
    ...
    pub fn parse_subscribe_message(&mut self, fixed_header: FixedHeader) -> Result<MqttMessage, String> {
        ...
        while self.cursor < self.buf.len() {
            ...
            println!("GOT TOPIC AND QOS {} {}. cursor at {}", topic, qos, self.cursor);
